...
This tutorial is inspired by or adapts material by Jesse Sadler and Douglas A. Luke, among others (see the bibliography below). It was created as an "R Notebook"" which can be used by anyone directly if you have [R installed](https://www.r-project.org/) and open the file in [RStudio](https://www.rstudio.com/). You can download the files used in this tutorial [here in the github repository](https://github.com/kmlawson/dh-tutorials/tree/master/networks/gangsters-and-revolutionaries). If you open this notebook in RStudio, you will see the code and can run all of it in one go with cmd/ctrl-option-r. Alternatively, you can run code from a single section using cmd/ctrl-shift-enter. Many of the questions below ask you to see what happens when you tweak some of the code found here.
